...
class RoomSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $room1->facilities()->sync([1, 2, 3, 4, 5, 6, 7, 8]);
        ...
        $room2->facilities()->sync([1, 2, 3, 4, 5, 6, 7, 8]);
        ...
        $room3->facilities()->sync([1, 3, 4, 5, 7, 8]);
        ...
        $room4->facilities()->sync([1, 2, 3, 4, 5, 6, 7, 8]);

        $room5 = Room::updateOrCreate(
            ['room_number' => 'B02'],
            [
                'room_type' => 'bulanan',
                'capacity' => 2,
        ...
        $room5->facilities()->sync([1, 2, 3, 4, 5, 6, 7, 8]);

        // Kamar Harian
        $room6 = Room::updateOrCreate(
            ['room_number' => 'C01'],
            [
                'room_type' => 'harian',
                'capacity' => 1,
        ...
        $room6->facilities()->sync([1, 2, 3, 6, 7]);

        $room7 = Room::updateOrCreate(
            ['room_number' => 'C02'],
            [
                'room_type' => 'harian',
                'capacity' => 2,
        ...
        $room7->facilities()->sync([1, 2, 3, 6, 7]);

        $room8 = Room::updateOrCreate(
            ['room_number' => 'D01'],
            [
                'room_type' => 'bulanan',
                'capacity' => 1,
        ...
        $room8->facilities()->sync([1, 2, 3, 4, 5, 7]);
