...
<div class="max-w-2xl">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Form Tambah Fasilitas</h3>
        </div>

        <form action="{{ route('admin.facilities.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="Contoh: WiFi, AC, Kasur"
                    required
                >
                @error('name')
            ...
            <div>
                ...
                >
                <p class="mt-1 text-xs text-gray-500">Icon class dari Heroicons atau icon library lainnya</p>
                @error('icon')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
