    ...
    <div class="flex h-screen overflow-hidden">
        ...
        >
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a href="{{ route('admin.profile.edit') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.profile.*') ? 'bg-green-700 bg-opacity-50' : 'hover:bg-green-700 hover:bg-opacity-30' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.users.*') ? 'bg-green-700 bg-opacity-50' : 'hover:bg-green-700 hover:bg-opacity-30' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
